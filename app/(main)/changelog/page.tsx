...
const RELEASES = [
  {
    ...
    tag: "Latest",
    changes: [
      { type: "feat", text: "AI schema generation — describe your data model in plain English and let GPT-4 or Claude build it" },
      { type: "feat", text: "Drag & drop table builder — create tables, columns, and relationships visually" },
      { type: "feat", text: "Firebase Firestore, Oracle, and SQL Server engine adapters" },
      { type: "feat", text: "Natural language to SQL/NoSQL migration script generation" },
      { type: "fix", text: "Resolved edge rendering glitches when switching between database engines" },
    ],
  },
  {
    version: "0.5.0",
    ...
    tag: null,
    changes: [
      { type: "feat", text: "Multi-engine support — PostgreSQL, MySQL, SQLite, MongoDB adapters" },
      { type: "feat", text: "Universal schema builder with engine-aware column types" },
      { type: "feat", text: "MariaDB and CockroachDB adapter support" },
      { type: "feat", text: "One-click engine switching to re-target existing schemas" },
      { type: "fix", text: "Improved type mapping accuracy across SQL dialects" },
    ],
  },
  {
    version: "0.4.0",
    ...
    changes: [
      ...
      { type: "fix", text: "Improved edge routing for complex overlapping tables" },
  ...
  },
  {
    ...
    tag: null,
    changes: [
      { type: "feat", text: "Crow's foot markers for many-to-many relationships" },
      { type: "feat", text: "Directional arrow markers for one-to-many relationships" },
      { type: "feat", text: "System columns (id, created_at, updated_at) on every table card" },
      { type: "feat", text: "Gray neutral zebra striping for column rows" },
      { type: "fix", text: "Removed duplicate edges for mirrored relationship pairs" },
      { type: "fix", text: "Port dots now correctly target primary key row for foreign key links" },
    ],
  },
  {
    version: "0.2.0",
    ...
    changes: [
      ...
      { type: "feat", text: "Create databases, tables, and columns from the studio" },
      { type: "fix", text: "Improved auto-layout algorithm for initial table placement" },
    ],
  },
  {
    version: "0.1.0",
    ...
    tag: null,
    changes: [
      { type: "feat", text: "Initial release — connect to your database via connection string or API credentials" },
      { type: "feat", text: "List databases and tables from the left sidebar" },
      { type: "feat", text: "Render tables as cards on a canvas" },
      { type: "feat", text: "Basic relationship line rendering between tables" },
    ],
  },
];

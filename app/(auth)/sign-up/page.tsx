  ...
  return (
    ...
    >
      <div className="mb-8 text-center">
        ...
        <h1 className="text-3xl text-zinc-900">Create your account</h1>
        <p className="mt-1 text-sm text-zinc-600">Start shaping schemas in under a minute.</p>
      </div>
      ...
      <p className="mt-6 text-center text-sm text-zinc-600">
        ...
        <Link href="/sign-in" className="text-emerald-600 hover:text-emerald-700 transition">
          Sign in
        </Link>
      </p>
    </motion.div>
